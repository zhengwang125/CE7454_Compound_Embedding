...
f_node_labels = open('DHFR_node_labels.txt')
f_node_attributes = open('DHFR_node_attributes.txt')
f_graph_indicator = open('DHFR_graph_indicator.txt')
f_graph_labels = open('DHFR_graph_labels.txt')
f_graph = open('DHFR_A.txt')
